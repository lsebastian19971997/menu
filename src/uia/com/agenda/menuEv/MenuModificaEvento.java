...
public class MenuModificaEvento extends APantalla {
    ...
    public MenuModificaEvento(String menú_principal, String s, String[] opciones, String s1, String s2) {
